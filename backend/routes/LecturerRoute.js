...
import {
  ...
  showAllTeachingHistory,
  getTeachingHistoryById,
  updateTeachingHistory,
  deleteTeachingHistory,
} from "../controllers/TeachHistoryController.js";
import {
...
} from "../controllers/EduHistoryController.js";
import {
  createResearch,
  showAllResearch,
  getResearchById,
...
import {
  ...
  updatePKM,
  deletePKM,
} from "../controllers/PkmController.js";
...
router.get(
  "/teaching-history/:id_dosen/:id_teaching_history",
  getTeachingHistoryById
);
...
router.get(
  "/education-history/:id_dosen/:id_education_history",
  getEducationHistoryById
);
router.patch(
  "/education-history/:id_education_history",
  updateEducationHistory
);
router.delete(
  "/education-history/:id_education_history",
